...
class CruiseApplication : Application() {
    ...
    override fun onCreate() {
        super.onCreate()
        // The bound input worker owns only Binder callbacks, never music caches or account state.
        if (com.cruisetune.player.steering.SteeringBridgeService.isBridgeProcess(packageName)) return
