...
class UiReviewFixesTest {
    ...
    @Test fun returningFromDetailsRestoresTheListPosition() {
        ...
        try {
            ...
            // Wait for AsyncListDiffer's initial commit before scrolling: its restoration
            // callback would otherwise overwrite the scroll requested by this fixture.
            val deadline=System.nanoTime()+java.util.concurrent.TimeUnit.SECONDS.toNanos(5)
            while(list.adapter!!.itemCount!=100 && System.nanoTime()<deadline) {
                Thread.sleep(10);shadowOf(Looper.getMainLooper()).idle()
            }
            assertEquals(100,list.adapter!!.itemCount);measure(a,360,664)
